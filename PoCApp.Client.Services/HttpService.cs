...
namespace PoCApp.Client.Services
{
    ...
    public class HttpService : IHttpService
    {
        ...
        //private async Task<IEnumerable<T>> sendRequests<T>(HttpRequestMessage request)
        //{
        //    // add jwt auth header if user is logged in and request is to the api url
        //    //var accessToken = await _localStorageService.GetItemAsync<string>("accessToken");
        //    var user = await _localStorageService.GetItemAsync<AspNetUser>("user");
        ...
        //        request.Headers.Authorization = new AuthenticationHeaderValue("Bearer", user.EmailAddress);
